    ...
    >
      <div className="relative hidden lg:flex flex-col w-[55%] overflow-hidden  bg-neutral-6">
        ...
        <div className="absolute top-11 left-0 right-0 text-center z-3 pointer-events-none">
          <p
            className="mt-2.5 mb-0 uppercase tracking-[0.35em] text-xs text-green-4 font-light"
            style={{ fontFamily: "'DM Mono', monospace" }}
          >
        ...
        <div
          className="absolute bottom-7 left-1/2 -translate-x-1/2 flex gap-5.5 z-2 tracking-1 text-xs text-green-4 select-none"
          style={{ fontFamily: "'DM Mono', monospace" }}
        >
      ...
      <div className="flex-1 flex items-center justify-center px-8 py-10 relative bg-neutral-6">
        <span
          className="absolute top-8 right-8 text-xs tracking-1 text-green-4 font-light z-2 uppercase select-none"
          style={{ fontFamily: "'DM Mono', monospace" }}
        >
          ♙ Your move
        </span>
        ...
        <span
          className="absolute bottom-8 left-8 text-xs tracking-1 text-green-4  font-light  z-2 uppercase  select-none"
          style={{ fontFamily: "'DM Mono', monospace" }}
        >
          e4 · e5 · Nf3
        </span>
